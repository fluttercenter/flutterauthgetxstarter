...
class AuthController extends GetxController {
  ...
  Future signup(String phoneIn, String firstNameIn, String lastNameIn,
      String passwordIn, String genderIn) async {
    signupScreen = false;
    update();
    user = await AuthApi()
        .signupAPI(phoneIn, firstNameIn, lastNameIn, passwordIn, genderIn);
    if (user!.status == 200) {
      await box.write("token", user!.token);
      update();
      Get.offAndToNamed("/home");
